	...
	<body>
		...
		<div class="admin-content">
			<div class="content">
				...
				<?php
				$sql = "SELECT customer_id, fname, lname, contact_no, nic, email, no, street, city FROM customer WHERE status=1";
				...
				if ($result->num_rows > 0) {
					...
					while ($row = $result->fetch_assoc()) {
						echo "<tr>
									...
									<td><a href=\"./php/user_disable.php?customer_id=" . $row["customer_id"] . "\" class=\"delete\">Disable</a></td>
